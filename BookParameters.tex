...
% Updated 2026: KDP white 50lb default; CreateSpace folded into KDP in 2018.
% -- KDP/Ingram: page count MUST be divisible by 2.
...
\def\ThePrinter{KDP (Kindle Direct Publishing)}
...
% KDP and Ingram use different paper stock; adjust spine width accordingly.
% KDP white 50lb (default): multiply page count by 0.002252
%
\pgfmathsetmacro\SinglePageThicknessPt{0.002252in}% KDP, White 50lb B&W Paper
