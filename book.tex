...
% -----------------------------------------------------------------------------
\documentclass[        % KOMA-Script Book Formatting (LuaLaTeX; no pagesize=pdftex)
  twoside=true,
  paper=6in:9in,
  DIV=calc,
...
\Boolean{USELUATEX}   {true}   % LuaLaTeX engine (false = pdfLaTeX fallback)
\Boolean{ACCESSIBLE}  {true}   % Accessibility metadata for EPUB
\Boolean{USESIUNITX}  {true}   % Load siunitx for units
\Boolean{LEGACYTOC}   {false}  % Use legacy shorttoc summary TOC
...
\KOMAoptions{toc=indented,toc=bibliography,toc=index}
\pdfbookmark[1]{Contents}{toc}%
\ifthenelse{\boolean{LEGACYTOC}}{%
  \begingroup
    \setlength{\parskip}{-2pt}%
    \shorttoc{Summary Contents}{0}%
  \endgroup
  \cleardoublepage
}{%
  \summaryTOC
