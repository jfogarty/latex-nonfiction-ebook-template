...
\Boolean{NOAUTHORS}   {true}   % Authors Cited deferred for EPUB (biblatex+tex4ht)
\Boolean{NOHYPERREF}  {true}   % Avoid nested anchors in EPUB (EPUBCheck)
...
\Boolean{USELUATEX}   {false}  % make4ht uses pdfLaTeX
\Boolean{ACCESSIBLE}  {true}
\Boolean{USESIUNITX}  {false}  % siunitx conflicts with tex4ht in sample
