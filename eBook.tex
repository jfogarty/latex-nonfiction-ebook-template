...
% or other ebook venders.
%
% Note: the makebook script should be used to do the actual formatting.
% The Calibre eBook editor should be run to check the resulting epub for
% quality. Run the Calibre error checker and edit until clean.
%
% After fixing all Calibre detected errors run epubcheck (4.0) to catch
% additional ones which will still exist. Fix until clean.
%
